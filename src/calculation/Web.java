 ...
 * @author Lenovo
 */
public class Web implements FinalWeighting{
    // attribute
    public String name;
    public String nim;
    public double write;
    ...
    public Web(String name, String nim, double write, double coding, double interview) {
        this.name = name;
        this.nim = nim;
        this.write = write;
        this.coding = coding;
    ...
    public void MenghitungWrite() {
        writeResult = write * 0.4;
    }

    @Override
    public void MenghitungCoding() {
        codingResult = coding * 3.5;
    }

    @Override
    public void MenghitungInterview() {
        interviewResult = interview * 2.5;
    }
